...
- **Global scope**: `/Users/rkreddy/Ramakrishna/projects/ed_conner_courses/ai_coder/finally/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/rkreddy/Ramakrishna/projects/ed_conner_courses/ai_coder/finally/.claude/notes/`)
...
2. Glob `/Users/rkreddy/Ramakrishna/projects/ed_conner_courses/ai_coder/finally/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/rkreddy/Ramakrishna/projects/ed_conner_courses/ai_coder/finally/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/rkreddy/Ramakrishna/projects/ed_conner_courses/ai_coder/finally/.claude/notes/` — works in any directory
